...
<template>
    <div>
        <div class="font-bold ... w-120 h-50 rounded overflow-hidden shadow-lg p-12 m-10 snap-start bg-teal-400">
    <div>
        <svg width="60%" height="60%" viewBox="0 0 500 150" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="
              fill-rule: evenodd;
              clip-rule: evenodd;
          ...
          <h1>email contacto@isclab.com.mx</h1>
    </div>
